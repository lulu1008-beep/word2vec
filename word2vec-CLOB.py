...
with open('./Combined_CLOB.txt', 'w') as outfile:
...
with open("./Combined_CLOB.txt", 'r') as text1:
    file1 = text1.read()
...
model.wv.save_word2vec_format("./CLOB_vector.bin", binary=True)
print('model is saved.')
model = KeyedVectors.load_word2vec_format("./CLOB_vector.bin", encoding='ISO-8859-1', binary=True)
print('task is done')
